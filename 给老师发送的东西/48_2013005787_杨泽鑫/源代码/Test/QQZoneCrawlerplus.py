...
#             所以这里需要选中一下说说所在的frame，否则找不到下面需要的网页元素
            ...
            devices =  soup.find_all('span', {'class': 'custom-tail'}) #使用设备
...
#             下一个“下一页”超链接的id
            next_num += 1
#             因为在下一个循环里首先还要把页面下拉，而滚动条处在最外层的frame中，所以要跳到外层的frame上
